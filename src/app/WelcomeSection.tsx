        ...
        <Section>
            <div className="h-screen flex items-center justify-center text-white">
                <div>
                    ...
                    <p
                        className={`${notoSansRegular.className} text-md md:text-2xl text-center px-8 absolute bottom-14 left-1/2 -translate-x-1/2`}
                    >
                        טיפול CBT קוגנטיבי-התנהגותי ושיטות פורצות דרך ייחודיות
                        ברוח היהדות שיתנו לכם מענה למגוון בעיות
                    </p>
                </div>
            </div>
        </Section>
